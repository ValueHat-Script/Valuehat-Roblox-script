...
LMG2L["ScreenGui_1"], require;

-- 🚀 指令 1: 修改主標題 (ScriptName)
-- 使用方法: GUI:SetTitle("你的標題")
...
-- 🚀 指令 2: 新增按鈕 (Button)
-- 使用方法: GUI:AddButton("文字", function() ... end)
function LMG2L:AddButton(text, callback)
    local btn = Instance.new("TextButton")
    btn.Name = "ValueButton_" .. text
    btn.Parent = LMG2L["Main_5"] -- 確保指向你的 ScrollingFrame
